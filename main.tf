...
module "project-host" {
  source          = "github.com/gcp-innovate/gke-clusters.git/modules/project"
...
module "vpc-shared" {
  source     = "github.com/gcp-innovate/gke-clusters.git/modules/net-vpc"
...
module "vpc-shared-firewall" {
  source       = "github.com/gcp-innovate/gke-clusters.git/modules/net-vpc-firewall"
  project_id   = module.project-host.project_id
...
module "nat" {
  source         = "github.com/gcp-innovate/gke-clusters.git/modules/net-cloudnat"
  project_id     = module.project-host.project_id
  region         = var.region
  name           = "vpc-shared"
  router_create  = true
...
module "host-dns" {
  source          = "github.com/gcp-innovate/gke-clusters.git/modules/dns"
  project_id      = module.project-host.project_id
  type            = "private"
  name            = "example"
  domain          = "example.com."
...
module "vm-bastion" {
  source     = "github.com/gcp-innovate/gke-clusters.git/modules/compute-vm"
...
module "cluster-1" {
  source     = "github.com/gcp-innovate/gke-clusters.git/modules/gke-cluster"
...
module "cluster-1-nodepool-1" {
  source       = "github.com/gcp-innovate/gke-clusters.git/modules/gke-nodepool"
  count        = var.cluster_create ? 1 : 0
  name         = "nodepool-1"
  project_id   = module.project-svc-gke.project_id
